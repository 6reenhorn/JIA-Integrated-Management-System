      ...
      <section id="settings-account-system" className="scroll-mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <DashboardCard title="Account Settings">
            ...
            <button className="mt-4 px-4 py-2 bg-gray-100 border-2 border-gray-300 rounded-lg hover:bg-gray-200 transition-colors text-sm font-medium cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">
              Coming Soon
            </button>
          </DashboardCard>
