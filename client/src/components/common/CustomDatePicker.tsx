...
const CustomDateInput = React.forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement> & { value?: string }>((props, ref) => {
    ...
    return (
        <div className="relative">
            <input
                ...
                className={`${restProps.className} pr-10`}
                type="text"
            />
            <svg
                fill="#000000"
    ...
    const { dateFormat: contextDateFormat } = useDateFormat();
    
    const effectiveDateFormat = propDateFormat || contextDateFormat;
    ...
    return (
        ...
        <DatePicker
            ...
            className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:border-[#02367B] focus:ring-1 focus:ring-[#02367B] focus:outline-none transition-all duration-200 bg-gray-100 ${className}`}
