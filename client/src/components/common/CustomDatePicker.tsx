...
const CustomDateInput = React.forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement> & { value?: string }>((props, ref) => {
    ...
    return (
        ...
        <DatePicker
            ...
            className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[1.5px] focus:ring-blue-500 focus:outline-none transition-all duration-200 bg-gray-100 ${className}`}
