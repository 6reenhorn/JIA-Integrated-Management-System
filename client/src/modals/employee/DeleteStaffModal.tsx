      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-[18px] font-bold text-gray-900">Delete Employee</h3>
          ...
          <div className="bg-white rounded-lg p-3 mt-3 border border-red-100">
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                ...
                <div className="text-gray-900">{employeeId}</div>
              </div>
              {/* add more fields here if you pass them into props */}
            </div>
          </div>
        </div>
        ...
        <div className="mb-6">
          <p className="text-sm text-gray-700">
            Are you sure you want to delete this employee? This will remove the employee from your records permanently.
          </p>
        </div>
