        ...
        <form action="submit" className='flex flex-col gap-3'>
          <div className="shadow-md shadow-gray-200 rounded-md m-1 p-4">
            ...
            <div className='mt-2'>
              ...
              <div className="dropdown relative mt-[2px]" ref={employeeDropdownRef}>
                <div
                  ...
                  onClick={() => {
                    ...
                    if (!isEmployeeDropdownOpen) {
                      setTimeout(() => {
                        document.getElementById('employee_options')?.focus();
                      }, 0);
                    }
                  }}
                  onKeyDown={(e) => {
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    if (!isMonthDropdownOpen) {
                      setTimeout(() => {
                        document.getElementById('month_options')?.focus();
                      }, 0);
                    }
                  }}
                  onKeyDown={(e) => {
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    if (!isYearDropdownOpen) {
                      setTimeout(() => {
                        document.getElementById('year_options')?.focus();
                      }, 0);
                    }
                  }}
                  onKeyDown={(e) => {
                  ...
                  <div
                    ...
                    onClick={() => {
                      ...
                      if (!isStatusDropdownOpen) {
                        setTimeout(() => {
                          document.getElementById('status_options')?.focus();
                        }, 0);
                      }
                    }}
                    onKeyDown={(e) => {
