                        ...
                        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                <div className="dropdown relative" ref={transactionTypeRef}>
                                    ...
                                    <div
                                        className={`dropdown-selected relative flex items-center justify-between bg-gray-100 border border-gray-300 rounded-md px-3 py-2 text-gray-700 transition-all duration-200 h-[29px] hover:border-gray-400 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500`}
