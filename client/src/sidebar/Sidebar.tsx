...
const Sidebar: React.FC<SidebarProps> = ({ activeItem, onItemClick, onToggle, isCollapsed, currentSection }) => {
  ...
  const renderFullSidebar = (itemId: string) => {
    ...
    return (
      <div className="bg-[#02367b] text-white h-full flex flex-col shadow-lg overflow-hidden">
        <div>
  ...
  return (
    <div className="relative flex h-screen">
      ...
      <div className="bg-[#02367b] text-white w-16 min-h-screen flex flex-col py-4 space-y-2 flex-shrink-0 border-r border-[#E9EBF080]">
        <div 
